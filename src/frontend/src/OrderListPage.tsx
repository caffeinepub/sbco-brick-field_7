...
import { deleteLocalOrder, getLocalOrders } from "./localOrderStore";
            ...
            >
                ...
                >
                  <p
                    style={{
                      fontSize: "0.55rem",
                      color:
                        currentExpanded === "bricks" ? "#2e7d32" : "#9e9e9e",
                      textTransform: "uppercase",
                  ...
                  <p
                    style={{
                      ...
                      fontWeight: 800,
                      color:
                        currentExpanded === "bricks" ? "#2e7d32" : "#212121",
                      margin: 0,
                    }}
                  >
              ...
              {currentExpanded === "bricks" && (
                ...
                >
                  ...
                  {/* Show the initial order as a history entry */}
                  <div
