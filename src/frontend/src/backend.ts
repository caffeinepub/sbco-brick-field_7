...
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<BrickItem>, arg5: bigint, arg6: bigint, arg7: bigint, arg8: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateMetrics(arg0: Metrics): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMetrics(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
